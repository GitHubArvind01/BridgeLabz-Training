...
public class Main {
	...
	public static void main(String[] args) {
		...
		while(true){
			...
			System.out.println("Enroll Course-> enter 'E' : ");
			...
			switch(c){
				case 'C':
					...
					if(instruct=='N') {
						int temp = randomcourseId();
						Course newCourse = new Course(title,temp,name,0.0,modules);
						instructor.addCourse(randominstructorId(), newCourse);
						System.out.println("Your instructor Id is: "+temp);
						break;
					}
					break;
				case 'I':
