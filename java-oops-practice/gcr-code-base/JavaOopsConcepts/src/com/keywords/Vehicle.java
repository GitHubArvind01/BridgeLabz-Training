...
public class Vehicle {
   ...
   // Instance variables
   private final String registrationNumber; // Final registration number cannot be changed
   ...
   public String getRegistrationNumber() {
	...
	public static void main(String[] args) {
		  // Update the registration fee for all vehicles
	       ...
	       Vehicle vehicle1 = new Vehicle("Lucky raj", "Sedan", "ABC123");
	       Vehicle vehicle2 = new Vehicle("pappu", "BMW", "XYZ789");
