package com.questions.employee_officesystem;
...
public class Main {
	...
	public static void main(String[] args) {
		Employee ramu = new Employee(101,"ramu",21,"male","IT",6,80000);
		Employee sujata = new Employee(102,"sujta",31,"female","IT",8,70000);
		Employee yuk = new Employee(107,"yuk",22,"female","IT",2,67000);
		Employee kali = new Employee(103,"kali",37,"male","Automation",1,1390000);
		Employee ravi = new Employee(104,"ravi",45,"male","Pharma",4,890000);
		Employee suriya = new Employee(105,"suriya",32,"male","Hardware",3,10000);
